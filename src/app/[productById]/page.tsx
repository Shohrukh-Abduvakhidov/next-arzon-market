...
const Page = () => {
	...
	if (!product) {
		return (
			<div className='inset-0 flex justify-center bg-white items-center fixed'>
				<Loader />
			</div>
		)
	}
	...
	return (
		<div className='flex w-[95%] flex-col lg:flex-row m-auto gap-[20px] items-start'>
			...
			<div className='pt-[20px]'>
				<p className='lg:text-[40px] text-[25px] text-black font-bold'>
					{product.name.en}
				</p>
				<p className='text-[40px] text-black font-bold'>{product.price}$</p>
				<p className='text-[20px] text-[#474747] font-bold'>
